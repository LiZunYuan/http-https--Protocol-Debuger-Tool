...
class AboutMe(wx.Dialog):
    def __init__(self, parent):
        ...
        # wx.StaticText(self, -1, '邮箱:', pos=(45, 170))
        # wx.HyperlinkCtrl(self, -1, 'codekami', 'codekami@qq.com', pos=(85, 170))

        wx.StaticText(self, -1, '邮箱:', pos=(45, 200))
        wx.HyperlinkCtrl(self, -1, 'codekami@qq.com', 'mailto:codekami@qq.com', pos=(85, 200))
        ...
        wx.HyperlinkCtrl(self, -1, 'GitHub', 'https://github.com/LiZunYuan/http-https--Protocol-Debuger-Tool', pos=(85, 230))
